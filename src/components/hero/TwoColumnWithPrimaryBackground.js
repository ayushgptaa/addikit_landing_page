...
const Header = tw(HeaderBase)`max-w-none -mt-8 py-4 -mx-8 px-20 `;
const NavLink = tw(
	NavLinkBase
)`lg:text-gray-100 lg:hocus:text-gray-300 lg:hocus:border-gray-100 lg:text-xs font-normal text-textlight`;
const LogoLink = tw(LogoLinkBase)`text-gray-100 hocus:text-gray-300`;
const PrimaryLink = tw(
	PrimaryLinkBase
)`shadow-raised bg-main lg:hocus:bg-primary-100 border border-primary-100 lg:text-xs font-normal text-textlight`;

const Container = tw(ContainerBase)``;
const Row = tw.div`flex items-center flex-col mx-auto`;
const Column = tw.div``;
const TextColumn = tw.div`text-center mx-auto z-10 `;
const IllustrationColumn = tw(Column)`mt-16 lg:mt-0 mx-auto lg:-mt-32 z-0 relative `;
const Heading = tw(
	SectionHeading
)`max-w-3xl lg:max-w-xl lg:text-center leading-normal tracking-normal font-medium lg:text-3xl`;
const Description = tw(SectionDescription)`mt-4 max-w-2xl lg:text-base mx-auto lg:mx-0 text-textlight font-medium`;
